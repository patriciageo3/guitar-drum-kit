window.onload = function() {
    ...
    function removeAnimation(e) {
        if (e.propertyName !== "transform") return; // i want to remove class after the most time-consuming change has ended
    ...
    function changeBg() {
        let imageArr = ["01.jpg", "02.jpg", "03.jpg"];
    ...
    window.setInterval(changeBg, 12000);
